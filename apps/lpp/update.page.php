...
if(isset($_POST['update'])) {
    ...
    $query2 = $pdo->prepare('UPDATE profil SET nama=?, email=?, jk=?, tpl=?, tgl=?, alamat=?, kota=?, telp=?, masuk_kls=?, masuk_tgl=?, asal_sekolah=?, alamat_sekolah=?, tahun_ijazah=?, no_ijazah=?, posted=?, updated=? WHERE uid=?') or die('Gagal mengecek profil di database');
    $data_profil = array($nama, $email, $jk, $tpl, $tgl, $alamat, $kota, $telp, $msk_kls, $msk_tgl, $asal_sekolah, $alamat_sekolah, $thn_ijazah, $no_ijazah, $posted, $updated, $uid);
...
<div class="control-group">
  ...
  <div class="controls">
    <input id="masuk_kelas" name="masuk_kelas" placeholder="Masuk Al Irsyad di Unit" class="input" type="text" value="<?=$data['msk_kls']?>">  
  </div>
</div>
...
<!-- Text input-->
<div class="control-group">
  <label class="control-label">Universitas  1y 11
   1label>
  <div class="controls">

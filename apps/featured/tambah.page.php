...
if(isset($_POST['tambah'])) {
	...
	$data = array($kid,$judul,$seo,$isi,$file_name,$pub,$featured,$post);
	$query = $pdo->prepare('INSERT INTO artikel (kid,judul,seo,isi,foto,publish,featured,post_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?)');
	$query->execute($data);

	redirect('/featured');
}	
?>	
<h2>Tambah Featured Artikel</h2>

...
<!-- Text input-->
<div class="control-group">
  <label class="control-label">Mate Pelajaran</label>
  <div class="controls">
    <input id="ayah" name="ayah" placeholder="" class="input-xlarge" type="text" value="<?=$mapel?>">  
  </div>
</div>

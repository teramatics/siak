...
if(isset($_GET['update'])) {
	...
	$data_profil = array($nama, $email, $jk, $tpl, $tgl, $alamat, $kota, $telp, $ayah, $ayah_kerja, $ibu, $ibu_kerja, $wali, $wali_kerja, $alamat_ortu, $kota_ortu, $telp_ortu, $msk_kls, $msk_tgl, $asal_sekolah, $thn_ijazah, $no_ijazah, $posted, $updated, $uid);
...
<div class="control-group">
  ...
  <div class="controls">
    ...
    <button id="update" name="update" class="btn btn-primary"><i class="icon-upload"></i> Update</button>
  </div>
</div>
